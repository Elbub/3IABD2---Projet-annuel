...
def fonction_principale():
   ...
   def choix_des_documents_a_conserver():
      ...
      Radiobutton(fenetre_de_choix_des_doc_a_conserver, text="que les trucs bof", variable=choix_des_documents_a_enregistrer, value=1).grid(row=2,column=1,padx =10, pady =10)
      Radiobutton(fenetre_de_choix_des_doc_a_conserver, text="que les trucs bien", variable=choix_des_documents_a_enregistrer, value=2).grid(row=3,column=1,padx =10, pady =10)
      Radiobutton(fenetre_de_choix_des_doc_a_conserver, text="TOUT ! JE VEUX TOUT !! MOUAHAHAHAHAH !!!", variable=choix_des_documents_a_enregistrer, value=3).grid(row=4,column=1,padx =10, pady =10)
   ...
   canvas=Canvas(fenetre_principale, height=int(hauteur_de_l_ecran / 2),width = largeur_de_l_ecran / 3)
