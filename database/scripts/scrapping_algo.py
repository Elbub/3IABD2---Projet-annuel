...
def get_images(api_key, search: str, page: int = 1):
    ...
    if 'error' not in results and 'images_results' in results:
        ...
        for i, image in enumerate(images):
            ...
            if image_url:
                ...
                file_name = f"image_{day.strftime('%Y-%m-%d_%H-%M')}_{i}.jpg" # nom du fichier
...
if __name__ == "__main__":
    print("hello")
    res = get_images(API_KEY, 'greek ruins', 2)
    store_images(res, "rome_grece")
